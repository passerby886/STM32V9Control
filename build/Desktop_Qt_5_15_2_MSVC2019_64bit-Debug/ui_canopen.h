/********************************************************************************
** Form generated from reading UI file 'canopen.ui'
**
...
public:
    ...
    void setupUi(QWidget *CANopen)
    {
        ...
        pushButton_pw = new DataButton(CANopen);
        pushButton_pw->setObjectName(QString::fromUtf8("pushButton_pw"));
        pushButton_pw->setGeometry(QRect(280, 550, 200, 100));
        pushButton_refresh = new QPushButton(CANopen);
        pushButton_refresh->setObjectName(QString::fromUtf8("pushButton_refresh"));
        pushButton_refresh->setGeometry(QRect(620, 50, 100, 40));

        retranslateUi(CANopen);

        QMetaObject::connectSlotsByName(CANopen);
    } // setupUi

    void retranslateUi(QWidget *CANopen)
    {
        CANopen->setWindowTitle(QCoreApplication::translate("CANopen", "Widget", nullptr));
        pushButton_beep->setText(QString());
        pushButton_temp->setText(QString());
        pushButton_hum->setText(QString());
        pushButton_open->setText(QCoreApplication::translate("CANopen", "\346\211\223\345\274\200\350\256\276\345\244\207", nullptr));
        pushButton_relay->setText(QString());
        pushButton_led1->setText(QString());
        pushButton_vr->setText(QString());
        label_server->setText(QCoreApplication::translate("CANopen", "CAN\350\256\276\345\244\207", nullptr));
        ...
        pushButton_refresh->setText(QCoreApplication::translate("CANopen", "\345\210\267\346\226\260\350\256\276\345\244\207", nullptr));
    } // retranslateUi

};

namespace Ui {
    class CANopen: public Ui_CANopen {};
} // namespace Ui
